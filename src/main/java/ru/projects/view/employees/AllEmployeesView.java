...
import ru.projects.view.employees.filter.EmployeeFilter;
...
public class AllEmployeesView extends Div {
    ...
    public AllEmployeesView(EmployeeService employeeService, SpecializationService specializationService) {
